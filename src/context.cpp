...
bool Context::Init() {
    ...
    m_brdfLookupProgram->SetUniform("transform", glm::scale(glm::mat4(1.0f), glm::vec3(2.0f, -2.0f, 2.0f)));
...
void Context::Render() {
    if (ImGui::Begin("ui window")) {
        ...
        ImGui::Checkbox("use irradiance", &m_useIBL);
    ...
    auto projection = glm::perspective(glm::radians(45.0f),(float)m_width / (float)m_height, 0.01f, 150.0f);
